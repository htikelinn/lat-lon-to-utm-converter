...
const CoordinateConverter: React.FC = () => {
    ...
    const handleShowOnMap = () => {
        if (result?.isValid && result.latLon) {
            ...
            const newItem = coordinate.trim();
            if (newItem) {
                setRecentList((prev) => {
                    const updated = [newItem, ...prev.filter((c) => c !== newItem)];
                    return updated.slice(0, 10); // keep only latest 5
                });
            }
        }
    };
    ...
    return (
        <div className="coordinate-converter flex">
            {/* Left column: Township list */}
            <div className="w-1/4 p-4 township-list">
            ...
            <div className="w-2/4 p-4">
                ...
                <div className="converter-card">
                    ...
                    <p className="description">
                        Enter coordinates in any supported format: Lat/Lon, MM_UTM (Myanmar). The
                        system will automatically detect and convert between all formats.
                    </p>
                        ...
                        {selectedLocation && result && (
                            <>
                                <Map
                                    ...
                                    coordinateInfo={{
                                        utm: result.utm
                                            ? formatUTMCoordinates(result.utm)
                                            : undefined,
                                        mmUtm: result.mmUtm
                                ...
                                <div className="map-info">
                                    ...
                                    <p>
                                        Click on the marker to see detailed coordinate information.
                                    </p>
                                </div>
                            </>
                        )}
                        ...
                        <div className="info-grid">
                            ...
                            <div className="info-item">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        Format: Zone + Band + Grid + Coordinates (up to 15
                                        characters).
                                    </li>
            ...
            <div className="w-1/4 p-4 recent-list">
                <h2 className="font-bold text-lg mb-2">🕑 Recent</h2>
                {recentList.length === 0 ? (
